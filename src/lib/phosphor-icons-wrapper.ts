// Centralized Phosphor icons export with aliases to avoid proxy fallbacks
...
// export { ArrowsUpDown as ArrowUpDown } from '@phosphor-icons/react';
export { ArrowDown as ArrowUpDown } from '@phosphor-icons/react';
export { ChartBar as BarChart } from '@phosphor-icons/react';
export { ChartPie as PieChart } from '@phosphor-icons/react';
export { Briefcase as Portfolio } from '@phosphor-icons/react';
export { Brain as Skills } from '@phosphor-icons/react';
export { ArrowsOut as Maximize } from '@phosphor-icons/react';
export { ArrowsIn as Minimize } from '@phosphor-icons/react';
export { PaperPlaneTilt as Send } from '@phosphor-icons/react';
// Close alternatives for missing names
